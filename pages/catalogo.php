                ...
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item" href="comprasC.php"><i class="bi bi-wallet2 me-2"></i>Mis Compras</a></li>
                            <li><a class="dropdown-item" href="pagosP.php"><i class="bi bi-exclamation-circle me-2"></i>Pagos Pendientes</a></li>
